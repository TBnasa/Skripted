...
export const BLOCK_COLORS: Record<BlockType, { bg: string; border: string; text: string; glow: string }> = {
  event:     { bg: 'bg-white/[0.08]', border: 'border-[var(--color-border-active)]', text: 'text-[var(--color-text-primary)]', glow: 'shadow-white/10' },
  ...
  comment:   { bg: 'bg-white/[0.05]',   border: 'border-[var(--color-border)]',  text: 'text-[var(--color-text-secondary)]', glow: 'shadow-white/10' },
} as const;
