...
export const skriptTheme: editor.IStandaloneThemeData = {
  ...
  rules: [
    ...
    { token: 'number', foreground: '3B6BF5' },
    { token: 'keyword', foreground: '00308C', fontStyle: 'bold' },
    { token: 'keyword.event', foreground: '1D4ED8', fontStyle: 'bold' },
    { token: 'keyword.command', foreground: '00308C', fontStyle: 'bold' },
    { token: 'keyword.function', foreground: '2563EB', fontStyle: 'bold' },
    { token: 'keyword.section', foreground: '1D4ED8', fontStyle: 'bold' },
    { token: 'keyword.effect', foreground: '2563EB' },
    { token: 'keyword.condition', foreground: '00308C' },
    { token: 'type', foreground: '2563EB' },
    { token: 'variable.local', foreground: '0B1B3D' },
    { token: 'variable.global', foreground: '1D4ED8' },
    { token: 'operator', foreground: '3B6BF5' },
    { token: 'delimiter.arrow', foreground: '3B6BF5' },
    { token: 'delimiter.colon', foreground: '0B1B3D' },
    { token: 'identifier', foreground: '0B1B3D' },
  ],
  colors: {
    'editor.background': '#FFFFFF',
    'editor.foreground': '#0B1B3D',
    'editor.lineHighlightBackground': '#EDF1F8',
    'editor.selectionBackground': '#DCE7FB',
    'editorCursor.foreground': '#1D4ED8',
    'editorLineNumber.foreground': '#9AA8C4',
    'editorLineNumber.activeForeground': '#1D4ED8',
    'editor.selectionHighlightBackground': '#DCE7FB80',
    'editor.wordHighlightBackground': '#DCE7FB80',
    'editor.wordHighlightStrongBackground': '#DCE7FB',
  },
};
