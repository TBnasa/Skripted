    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[var(--color-border)] bg-[var(--color-bg-primary)]/80 backdrop-blur-2xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Link
            href="/pricing"
            className="hidden sm:flex items-center gap-2 px-3 py-2 text-xs font-semibold text-[var(--color-text-muted)] transition-all duration-300 hover:text-emerald-400 rounded-lg whitespace-nowrap"
          >
          ...
          {pathname !== '/chat' && (
            <div className="flex items-center gap-2">
              <Link
                href="/dashboard"
                className="hidden md:flex items-center gap-2 px-3 py-2 text-xs font-bold text-zinc-400 hover:text-white transition-all bg-white/5 rounded-xl border border-white/5 hover:border-white/10"
              >
                {t('general.dashboard')}
              </Link>
              <Link
