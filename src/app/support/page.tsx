      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-3">
            <div className="bg-[var(--color-bg-secondary)] border border-[var(--color-border)] rounded-2xl p-8 shadow-2xl h-full">
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl bg-[var(--color-accent-primary)] hover:brightness-110 text-black font-bold text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 active:scale-[0.98]"
                  >
                    {status === 'loading' ? (
                      <>
          ...
          <div className="lg:col-span-2 space-y-6">
            {contactDetails.map((detail) => (
              <a
                key={detail.label}
                href={detail.href}
                className="block group p-6 rounded-2xl bg-[var(--color-bg-secondary)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-all duration-300"
              >
            ...
            <div className="p-6 rounded-2xl bg-[var(--color-bg-secondary)] border border-[var(--color-border)]">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.03] border border-white/[0.06] text-xs font-bold text-[var(--color-text-muted)] hover:text-white hover:bg-white/[0.06] hover:border-white/[0.12] transition-all"
                >
