            ...
            <div className="p-6 rounded-2xl bg-[var(--color-bg-secondary)] border border-[var(--color-border)]">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.03] border border-[var(--color-border)] text-xs font-bold text-[var(--color-text-muted)] hover:text-white hover:bg-white/[0.06] hover:border-[var(--color-border-hover)] transition-all"
                >
