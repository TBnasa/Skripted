  ...
  return (
    <div className="hidden md:flex items-center gap-4">
      <a
        ...
        className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-[var(--color-text-muted)] transition-all duration-300 hover:text-[var(--color-accent-primary)] rounded-lg hover:bg-[var(--color-accent-glow)]"
      >
      ...
      >
        ...
        {t('pricing.title')}
        <span className="w-1.5 h-1.5 rounded-full bg-[var(--color-accent-primary)] animate-subtle-pulse"></span>
      </Link>
      ...
      <div
        className="group relative flex items-center gap-2 px-3 py-2 text-xs font-semibold text-[var(--color-text-muted)] cursor-not-allowed transition-all duration-300 rounded-lg"
      ...
      {!pathname.startsWith('/dashboard') && pathname !== '/chat' && (
        <>
          <Link
            href="/dashboard"
            className="flex items-center gap-2 px-3 py-2 text-xs font-bold text-[var(--color-text-secondary)] hover:text-[var(--color-accent-primary)] transition-all"
          >
            {t('general.dashboard')}
          </Link>
