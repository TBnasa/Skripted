...
export default function FooterCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--color-bg-primary)] px-6 pb-20 pt-12 md:pt-10">
      <div className="forge-glow absolute inset-0 opacity-80" />
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto max-w-4xl rounded-3xl border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-10 text-center md:p-16"
      >
        {/* eyebrow */}
        <div className="mb-5 flex items-center justify-center gap-2 font-mono text-[11px] font-semibold uppercase tracking-[0.25em] text-[var(--color-accent-primary)]">
        ...
        <h2 className="mb-6 text-3xl font-black tracking-tight text-balance text-[var(--color-text-primary)] md:text-5xl">
          ...
          <span className="text-[var(--color-accent-primary)] glow-text">{t('footer.cta_title_suffix', { defaultValue: 'Start forging.' })}</span>
        </h2>
        ...
        {/* legal */}
        <p className="mx-auto mt-14 max-w-2xl text-[11px] leading-relaxed text-[var(--color-text-muted)]">
